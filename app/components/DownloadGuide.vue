  ...
  <div class="guide-body mx-1">
    ...
    <div class="row g-4">
      <div class="col-12 col-lg-4">
        <div class="guide p-4" style="background-color: #065f46 !important;">
          <h1><Icon name="ph:film-slate-duotone" /></h1>
      ...
      <div class="col-12 col-lg-4">
        <div class="guide p-4" style="background-color: #065f46 !important;">
          <h1><Icon name="ph:download-simple-duotone" /></h1>
