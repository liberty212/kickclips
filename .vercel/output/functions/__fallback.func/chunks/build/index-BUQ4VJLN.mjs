...
import { v as vueExports, K as SEO, S as SITE, R as RESOURCES, p as publicAssetsURL } from '../nitro/nitro.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const url = vueExports.ref(props.channel && props.clipId ? `https://kick.com/${props.channel}/clips/${props.clipId}` : "");
    const clip = vueExports.ref(null);
    const loading = vueExports.ref(false);
    const error = vueExports.ref(null);
    const blob = vueExports.ref(null);
    const blobUrl = vueExports.ref(null);
    const getClip = async () => {
      error.value = null;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(vueExports.mergeProps({ class: "downloader-body justify-content-center mb-5 p-3 p-sm-4" }, _attrs))}><form><h2 class="col-12 fw-normal title mb-3 mb-sm-4">Enter clip URL</h2><div class="col-12 row input-body p-2 mb-3 mb-sm-4 mx-0 flex-nowrap"><input id="input"${ssrRenderAttr("value", vueExports.unref(url))} class="col-9 col-lg-10 col-sm-8" type="url" placeholder="https://kick.com/user/clips/clip_01A2BCD3EF4GHI5JKMNLOP67QR" required><button${ssrRenderAttrs(vueExports.mergeProps({
        id: "download",
        type: "submit",
      ...
      if (vueExports.unref(loading)) {
        ...
        _push(`<h5 class="error">${ssrInterpolate(vueExports.unref(error).message)}</h5>`);
      } else if (vueExports.unref(clip)?.channel) {
        _push(`<div id="clip" class="p-0"><div class="row"><div class="col-12 col-lg-4 info text-start mb-4"><div class="channel_profile"><img class="mb-1 img-fluid"${ssrRenderAttr("src", vueExports.unref(clip).channelPicture)}><a${ssrRenderAttr("href", `https://kick.com/${vueExports.unref(clip).slug}`)} class="text-decoration-underline" target="_blank"><h3 class="mb-3">${ssrInterpolate(vueExports.unref(clip).channel)}</h3></a><h5 class="mb-3">${ssrInterpolate(vueExports.unref(clip).title)}</h5><div class="clip_info d-flex gap-2 align-items-center">`);
        _push(ssrRenderComponent(_component_Icon, { name: "ph:heart-fill" }, null, _parent));
        _push(`<p><span class="fw-bold">${ssrInterpolate(vueExports.unref(clip).likes)}</span></p><p>likes</p></div><div class="d-flex gap-2 align-items-center">`);
        _push(ssrRenderComponent(_component_Icon, { name: "ph:eye-bold" }, null, _parent));
        _push(`<p><span class="fw-bold">${ssrInterpolate(vueExports.unref(clip).views)}</span></p><p>views</p></div><div class="d-flex gap-2 align-items-center">`);
        _push(ssrRenderComponent(_component_Icon, { name: "ph:clock-bold" }, null, _parent));
        _push(`<p><span class="fw-bold">${ssrInterpolate(("formatTime" in _ctx ? _ctx.formatTime : vueExports.unref(formatTime))(vueExports.unref(clip).duration))}</span></p><p>duration</p></div><div class="d-flex gap-2 align-items-center">`);
        _push(ssrRenderComponent(_component_Icon, { name: "ph:user-bold" }, null, _parent));
        _push(`<p><a${ssrRenderAttr("href", `https://kick.com/${vueExports.unref(clip).creatorSlug}`)} class="text-decoration-underline" target="_blank">${ssrInterpolate(vueExports.unref(clip).creator)}</a></p></div><div class="d-flex gap-2 align-items-center">`);
        _push(ssrRenderComponent(_component_Icon, { name: "ph:calendar-bold" }, null, _parent));
        _push(`<p><span>${ssrInterpolate(("getDate" in _ctx ? _ctx.getDate : vueExports.unref(getDate))(vueExports.unref(clip).date))}</span></p></div></div></div><div class="col-12 col-lg-8 video mb-4"><video class="img-fluid" width="1280" height="720" controls autoplay muted><source${ssrRenderAttr("src", vueExports.unref(clip).blob)} type="video/mp4"></video></div><div class="save"><a class="col-12 btn fw-bold mb-0"${ssrRenderAttr("href", vueExports.unref(clip).blob)} target="_blank"${ssrRenderAttr("download", vueExports.unref(clip).filename)}>Save file</a></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_Icon = __nuxt_component_0$1;
  _push(`<div${ssrRenderAttrs(vueExports.mergeProps({ class: "guide-body mx-1" }, _attrs))}><h3 class="mb-4">How to download a Kick clip?</h3><div class="row g-4"><div class="col-12 col-lg-4"><div class="guide p-4" style="${ssrRenderStyle({ "background-color": "#065f46 !important" })}"><h1>`);
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(vueExports.mergeProps({ class: "text-white" }, _attrs))}><div id="home" class="text-center container overflow-hidden"><div class="my-5">`);
      ...
      _push(ssrRenderComponent(_component_DownloadClip, {
        channel: vueExports.unref(queryParams).channel,
        "clip-id": vueExports.unref(queryParams).id
      }, null, _parent));
